	...
	public void addInterceptors(InterceptorRegistry registry) {
		...
		//LoginCheckInterceptor 설정
		   registry.addInterceptor(loginCheck)
		         ...
		         .addPathPatterns("/board/orderDetail.do")
		         .addPathPatterns("/board/giftList.do")
		         .addPathPatterns("/board/giftDetail.do")
		         ...
		         .addPathPatterns("/board/reviewWrite.do")
		         .addPathPatterns("/board/postList.do")
		         .addPathPatterns("/board/csList.do")
		         .addPathPatterns("/board/eventList.do")
		         ...
		         .addPathPatterns("/order/orderComplete.do")
		         .addPathPatterns("/order/orderFail.do")
		         .addPathPatterns("/order/searchMember.do")
		   		 .addPathPatterns("/movie/writeReport.do")

...
<div class="page-main">
	 <div class="page-main">
        ...
        <div class="event-detail">
            <h2>답변 수정</h2>
            <form action="csPersonalAdminUpdate.do" method="post" style="width: 100%;border: none;">
                    ...
                    <table class="board-form va-m">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td colspan="3"><input type="text" name="title" id="title" class="input-text" maxlength="100" value="${answer.title}" /></td>
                            </tr>
                            <tr>
                                <th scope="row"><label for="textarea">내용</label> <em class="font-orange">*</em></th>
                                <td colspan="3">
                                    <div class="textarea">
                                        <textarea id="textarea" name="content" rows="5" cols="30" title="내용입력" class="input-textarea">${answer.content}</textarea>
                                        <div class="util">
                                            <p class="count">

...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/store.snackUpdate.js"></script>
...
<div class="page-main">
	...
	<form:hidden path="sn_num"/>
		...
		<div id="snack_text">
			...
			<textarea rows="5" cols="60" name="sn_info" id="sn_info">${snackVO.sn_info}</textarea>
		</div>
		
		<div id="snack_ck">
			<label for="sn_notice">안내사항</label><p>
			<textarea name="sn_notice" id="sn_notice">${snackVO.sn_notice}</textarea>
				<script>

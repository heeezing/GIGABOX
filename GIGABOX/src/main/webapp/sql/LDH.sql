CREATE TABLE movie (
	...
	m_titleEng	varchar2(30)	NULL,
	m_director	varchar2(15)	NOT NULL,
	m_actor	varchar2(15)	NOT NULL,
	m_nation	varchar2(30)	NOT NULL,
	m_company	varchar2(30)	NOT NULL,
	m_plot	clob	NOT NULL,
	m_runtime	number	NOT NULL,
	m_rating	varchar2(24)	NOT NULL,
	m_genre	varchar2(30)	NOT NULL,
	m_opendate	date	NOT NULL,
	m_poster	blob	NOT NULL,
	m_stillimg	blob	NULL,
